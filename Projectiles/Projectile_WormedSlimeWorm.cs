...
namespace Ascension.Projectiles
{
    ...
    /// </summary>
    [CreatedBy(Dev.WaitWhatWolf, 2021, 08, 11), 
        Obsolete("Parasite Worm stuff no longer works that way."),
        Note(Dev.WaitWhatWolf, "Class is abstract generic to allow for different damage types, see first line in SetDefaults().")]
